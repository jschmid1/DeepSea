...
class Inventory():
    ...
    def raw(self) -> dict:
        ...
        # FIXME!
            ...
            log.error('handle this case properly')
            return False
...
def test(**kwargs):
    ...
    dg = DriveGroup(filter_args)
    print(dg.data_devices)
    print(dg.wal_devices)
    print(dg.db_devices)
    return dict(
        data_devices=dg.data_devices,
        wal_devices=dg.wal_devices,
        db_devices=dg.db_devices)
